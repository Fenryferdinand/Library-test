                    ...
                    <div class="row">
                        ...
                        <div
                            ...
                            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                style="background-image: url('https://storyblok-image.ef.com/unsafe/1200x600/filters:focal(603x501:604x502):quality(90)/f/60990/1200x666/34093b645f/perpustakaan.jpg');
              background-size: cover;">
                                <span class="mask bg-gradient-primary opacity-6"></span>
                                <h4 class="mt-5 text-white font-weight-bolder position-relative">"Reading is essential for those who seek to rise above the ordinary."</h4>
                                <p class="text-white position-relative"> Jim Rohn</p>
                            </div>
                        </div>
                    </div>
                </div>
